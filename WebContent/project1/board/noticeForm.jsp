...
<body>
	<form action="write.do" method="post" enctype="multipart/form-data" name="f">
		...
		<table>
			...
			<tr><td>제목</td><td><input type="text" name="subject" value="[공지]"></td></tr>
			<tr><td>내용</td><td><textarea rows="15" name="content"></textarea></td></tr>
			<tr><td>첨부파일</td><td><input type="file" name="file"></td></tr>
			<tr><td colspan="2" style="text-align: right"><a href="javascript:board_submit()"><input type="button" value="게시물 등록"></a></td></tr>
		</table>
	</form>
</body>
</html>