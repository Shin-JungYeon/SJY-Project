...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<div class="w3-center" style="margin-left:35%;margin-top:10%;">
		...
		<table class="css"  style="width: 50%;">
			<tr><th>요청 아이디</th><th>요청 이메일</th><th>승인</th><th>삭제</th></tr>
		<c:forEach var="jr" items="${joinreq }">
			<tr><td>${jr.reqid }</td><td>${jr.reqemail }</td>
				<td><a href="joinCon.do?reqid=${jr.reqid }">승인</a></td>
				<td><a href="">삭제</a></td>
			</tr>
		</c:forEach>
		</table>
