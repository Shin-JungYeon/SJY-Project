...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<div class="w3-center" style="margin-left:300px;margin-top:50px;">
		...
		<table  style="width: 20%; margin-left: 38%; margin-top: 200px;">
			...
			<tr><td>Gender</td><td colspan="2">${mem.gender==1?"남자":"여자" }</td></tr>
		...
		<c:if test="${mem.mclass==1 }">
			...
			<tr><td colspan="2"><a href="updateForm.me?id=${mem.id }"><input type="button" value="정보 수정"></a>
					<a href="deleteForm.me?id=${mem.id }"><input type="button" value="회원 탈퇴"></a></td>
			</tr>
		</table>
