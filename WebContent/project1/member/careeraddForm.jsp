...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<div class="w3-center" style="margin-left:300px;margin-top:50px;">
		<div style="margin-top: 50px; margin:auto; max-width: 1450px; min-width:700px;">
			<form action="careeradd.do" method="post">
				<input type="hidden" name="id" value="${param.id }">
				<table>
					<tr><td>내용</td><td><textarea rows="1" cols="20" name="content"></textarea></td></tr>
					<tr><td colspan="2" style="text-align: right"><input type="submit" value="추가"></td></tr>
				</table>
			</form>
		</div>
	</div>
