...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<div class="w3-center" style="margin-left:35%;margin-top:10%;">
		...
		<table class="css"  style="width: 30%;">
			<tr><th>요청 아이디</th><th>요청 상품명</th><th>승인</th><th>삭제</th></tr>
		<c:forEach var="pr" items="${pointreq }">
			<tr><td>${pr.reqid }</td>
				<td>${pr.itemname }</td>
				<td><a href="pointappr.do?reqid=${pr.reqid }">승인</a></td>
				<td><a href="paskdel.do?reqid=${pr.reqid }&reqno=${pr.no }">삭제</a></td>
			</tr>
		</c:forEach>
		</table>
	</div>
