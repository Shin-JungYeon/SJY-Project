...
<%-- /WebContent/project1/member/joinConForm.jsp --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="EUC-KR">
...
<body class="w3-light-grey w3-content" style="max-width:2400px">
	...
	<div>
		<div style="text-align: left; margin-left:250px;">관계자 회원가입</div>
		<form action="joinConReq.do" name="f" method="post">
...
/* 			
			$("#careeradd").click(function() {
				if($("#career").val()=="") {
					...
					var data = "<span><input type='text' disabled value='" + $("#career").val() + '>";
					$("#carcontent").html($("#career").val());
					$("#careercon").addClass("content");
				}
			})
*/
			$("#pass").keyup(function() {
